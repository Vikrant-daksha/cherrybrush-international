    ...
    <section className="w-full">
      <div className="w-full mx-auto flex flex-col md:flex-row items-center gap-10 bg-[#fddfdf]">
        ...
        <div className="shrink-0 bg-[#f5c6c6] rounded-br-xl rounded-tr-xl py-20 flex flex-col justify-center items-center gap-4 min-w-lg">
          ...
          <h3 className="font-serif text-2xl text-neutral-800 leading-snug">
            Simple. Quick.
            <br />
            Beautiful.
          </h3>
          <button className="border border-neutral-700 text-xs tracking-widest uppercase px-4 py-2 w-fit hover:bg-neutral-800 hover:text-white transition-colors">
            Discover How
          </button>
        </div>

        {/* Steps */}
        <div className="flex flex-wrap justify-center gap-28 flex-1 ">
          {steps.map((step) => (
